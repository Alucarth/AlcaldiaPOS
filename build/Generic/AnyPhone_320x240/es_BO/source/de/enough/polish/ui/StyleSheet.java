...
//$$IncludeStyleSheetDefinitionHere$$//
	...
	public static Style choiceitemfocusedStyle;
	public static Style browserinputfocStyle;
	public static Style choicegrouplabelStyle;
...
protected static final void initStyles0(){
	...
	choiceitemfocusedStyle = new Style (
		"choiceitemfocused", 
		Item.LAYOUT_DEFAULT,	// default layout
		null,	// no background
		null, 	// no border
		new short[]{ -14, -17, 150},
		new Object[]{ new Integer(Font.STYLE_BOLD), new Color( 0x000000, false), Style.FALSE}
	);
	...
	choicegrouplabelStyle = new Style (
		"choicegrouplabel", 
		Item.LAYOUT_NEWLINE_AFTER,
		null,	// no background
		null, 	// no border
		new short[]{ -14, -15},
		new Object[]{ new Integer(Font.STYLE_ITALIC), new Integer( Font.SIZE_SMALL )}
	);
	...
	horizontalchoicefocusedStyle = new Style (
		"horizontalchoicefocused", 
		Item.LAYOUT_EXPAND,
		new de.enough.polish.ui.backgrounds.RoundRectBackground( 0x0000FF,8, 8),
		null, 	// no border
		new short[]{ 3, 132, 39},
		new Object[]{ StyleSheet.choicegrouplabelStyle, Style.TRUE, new de.enough.polish.ui.containerviews.HorizontalChoiceView()}
	);
	...
	choiceitemStyle = new Style (
		"choiceitem", 
		Item.LAYOUT_DEFAULT,	// default layout
		null,	// no background
		null, 	// no border
		new short[]{ -14, -17, 150, 1},
		new Object[]{ new Integer(Font.STYLE_BOLD), new Color( 0x808080, false), Style.FALSE, StyleSheet.choiceitemfocusedStyle}
	);
	...
	horizontalchoiceStyle = new Style (
		"horizontalchoice", 
		Item.LAYOUT_EXPAND,
		new de.enough.polish.ui.backgrounds.RoundRectBackground( 0xFFFFFF,8, 8),
		null, 	// no border
		new short[]{ 3, 132, 39, 1},
		new Object[]{ StyleSheet.choicegrouplabelStyle, Style.TRUE, new de.enough.polish.ui.containerviews.HorizontalChoiceView(), StyleSheet.horizontalchoicefocusedStyle}
	);
	...
	StyleSheet.stylesByName.put( "choiceitemfocused", StyleSheet.choiceitemfocusedStyle );
	StyleSheet.stylesByName.put( "browserinputfoc", StyleSheet.browserinputfocStyle );
	StyleSheet.stylesByName.put( "choicegrouplabel", StyleSheet.choicegrouplabelStyle );
	...
	StyleSheet.stylesByName.put( "horizontalchoicefocused", StyleSheet.horizontalchoicefocusedStyle );
	StyleSheet.stylesByName.put( "browserchoicegrouppopup", StyleSheet.browserchoicegrouppopupStyle );
	StyleSheet.stylesByName.put( "choiceitem", StyleSheet.choiceitemStyle );
	...
	StyleSheet.stylesByName.put( "horizontalchoice", StyleSheet.horizontalchoiceStyle );
